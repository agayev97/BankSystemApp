Bu layihə bank sisteminin əməliyyatlarını (müştərilər, hesablar, köçürmələr, təhlükəsizlik və s.) idarə etmək üçün **.NET 8 Web API** və **Clean / Modulyar Arxitektura** əsasında hazırlanmış  backend və management sistemidir. 
---
